...
public class RegexViewer {
     ...
     * @param nodeName
     */
    public static void paintRegex(redosPattern redosPattern, Table nodes, Table edges, boolean directed, String from, String to, String nodeName) {
        ...
        btn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				redosMatcher m = redosPattern.matcher(inputStr, new Trace(1e4, true));
				Trace t = m.find();
				curStep = 0;
				btnn.setEnabled(true);
				stepsNum.setText(t.getMatchSteps() + "");
				paintLog(redosPattern, t.getLogNode(), t.getLogIdx(), ColorLib.rgb(200, 150, 150));
		}});
        btnn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				redosMatcher m = redosPattern.matcher(inputStr, new Trace(1e4, true));
				Trace t = m.find();
				paintLog(redosPattern, t.getLogNode(), t.getLogIdx());
				curStep++;
        ...
        jf.setTitle(redosPattern.pattern());
